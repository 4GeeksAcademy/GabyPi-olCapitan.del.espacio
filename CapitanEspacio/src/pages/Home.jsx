...
export default function Home() {
  ...
  // Funciones de llamada para permitir reintentos
  ...
  return (
    <div className="p-6 pb-16 space-y-6 max-w-[1600px] mx-auto animate-fade-in">
      
      {/* Encabezado */}
      <div>
        <h1 className="text-3xl font-extrabold text-white tracking-tight">Centro de Operaciones</h1>
        <p className="text-sm text-gray-400">Telemetría en tiempo real de agencias espaciales.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {asteroids.loading ? <LoadingCard /> : asteroids.error ? <ErrorCard message={asteroids.error} onRetry={loadAsteroids} /> : (
              <div className="bg-space-800/40 border border-gray-800 rounded-2xl p-5 flex flex-col justify-between hover:border-gray-700 transition-all duration-300">
                <div className="flex justify-between items-start">
                  <div>
                    <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Objetos Cercanos</span>
        ...
        <div className="space-y-6">
          ...
          {launch.loading ? <LoadingCard /> : launch.error ? <ErrorCard message={launch.error} onRetry={loadLaunch} /> : (
            <div className="bg-space-800/40 border border-gray-800 rounded-2xl overflow-hidden hover:border-gray-700 transition-all duration-300 flex flex-col justify-between">
              <div>
          ...
          {astronauts.loading ? <LoadingCard /> : astronauts.error ? <ErrorCard message={astronauts.error} onRetry={loadAstronauts} /> : (
            <div className="bg-space-800/40 border border-gray-800 rounded-2xl p-5 flex flex-col justify-between hover:border-gray-700 transition-all duration-300">
              ...
              {/* Lista limitada a 7 astronautas */}
